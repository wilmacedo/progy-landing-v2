...
const button = tv({
  base: "px-4 py-2 inline-flex items-center justify-center rounded-md text-center text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  variants: {
    color: {
      default:
