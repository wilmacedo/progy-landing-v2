export function GridPattern() {
  return (
    <svg
      ...
      fill="none"
      className="w-full max-w-[1600px] h-auto [grid-area:1/1/1/1]"
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.470178" stopColor="#fff"></stop>
          <stop offset="1" stopColor="#fff" stopOpacity="0"></stop>
        </radialGradient>
        <clipPath id="clip0_889_168141">
          <rect width="1600" height="920" fill="white"></rect>
        </clipPath>
        <clipPath id="clip1_889_168141">
          <rect x="200" y="104" width="1200" height="736" fill="white"></rect>
        </clipPath>
        <clipPath id="clip2_889_168141">
          <path d="M200 104H1400V840H200V104Z" fill="white"></path>
        </clipPath>
